...
// //   bool rentBat = false; // For cricket bat
...
// //             .collection("Users") // Because turfowner stored here
// //             .doc(widget.turfid) // the turf owner's UID
// //             .get();
...
// //   int calculateRentalPrice() {
// //   int total = 0;

// //   // Boots
// //   if (selectedBootSize != null) {
// //     total += bootCount * rentals!["football"]["boots"]["price"];
// //   }

// //   // Cricket Bat
// //   total += batCount * rentals!["cricket"]["bat"]["price"];

// //   // Racket
// //   total += racketCount * rentals!["badminton"]["racket"]["price"];
...
// //       String userId =
// //           userProvider
// //               .userId; // 🔹 Replace with FirebaseAuth.instance.currentUser!.uid if using Auth
...
// //                         onPressed: () {
// //                           if (bootCount > 0) setState(() => bootCount--);
// //                         },
// //                       ),
// //                       Text("$bootCount"),
// //                       IconButton(
...
// //                         onPressed: () {
// //                           if (bootCount <
// //                               rentals!["football"]["boots"]["sizes"][selectedBootSize]) {
// //                             setState(() => bootCount++);
// //                           }
// //                         },
// //                       ),
...
// //                   ),
// //                   Text(
// //                     "Price per boot: ₹${rentals!["football"]["boots"]["price"]}",
// //                   ),
// //                 ],

// //                 // CRICKET – BAT
// //                 if (rentals!["cricket"]["bat"]["enabled"]) ...[
// //                   Row(
// //                     children: [
// //                       Text(
// //                         "Cricket Bat",
...
// //                         icon: Icon(Icons.remove),
// //                         onPressed: () {
// //                           if (batCount > 0) setState(() => batCount--);
// //                         },
// //                       ),
// //                       Text("$batCount"),
// //                       IconButton(
...
// //                     ],
// //                   ),
// //                   Text("Available: ${rentals!["cricket"]["bat"]["quantity"]}"),
// //                   Text(
// //                     "Price per bat: ₹${rentals!["cricket"]["bat"]["price"]}",
// //                   ),
// //                 ],
...
// //                 Row(
// //                   children: [
// //                     Text("Racket", style: TextStyle(fontSize: 18)),
// //                     Spacer(),
// //                     IconButton(
// //                       icon: Icon(Icons.remove),
// //                       onPressed: () {
// //                         if (racketCount > 0) setState(() => racketCount--);
// //                       },
// //                     ),
// //                     Text("$racketCount"),
// //                     IconButton(
...
// //                       onPressed: () {
// //                         if (racketCount <
// //                             rentals!["badminton"]["racket"]["quantity"]) {
...
// //                 ),
// //                 Text(
// //                   "Price per racket: ₹${rentals!["badminton"]["racket"]["price"]}",
// //                 ),
// //               ],
